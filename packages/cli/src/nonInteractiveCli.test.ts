...
import { Config, GeminiClient, ToolRegistry } from '@super-young/gemini-cli-core';
import { GenerateContentResponse, Part, FunctionCall } from '@google/genai';

// Mock dependencies
vi.mock('@super-young/gemini-cli-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@super-young/gemini-cli-core')
  >('@super-young/gemini-cli-core');
  return {
    ...actualCore,
    GeminiClient: vi.fn(),
    ToolRegistry: vi.fn(),
